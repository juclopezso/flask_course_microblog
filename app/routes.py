...
# function executed right before any view function
@app.before_request
def before_request():
    # saves last transaction time of a user
...
# <username> is a dynamic component. eg. /user/susan
@app.route('/user/<username>')
@login_required
def user(username):
    # if no users sends error 404 (exception) to the client
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        # populate the forms when page is visited
